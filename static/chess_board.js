...
function drawPiece(curPiece, bBlackTeam)
{
    ...
    piece_img.src = "/static/pieces.png";
};
...
function drawSemiBoard(board_no) {
    ...
    if(SEMI_BRD_ORIENT[board_no] === 0){
        img.src="/static/" + board_no + "/board_0.png";
    }else if(SEMI_BRD_ORIENT[board_no] === 1){
        img.src="/static/" + board_no + "/board_1.png";
    }else if (SEMI_BRD_ORIENT[board_no] === 2) {
        img.src="/static/" + board_no + "/board_2.png";
    }else{
        img.src="/static/" + board_no + "/board_3.png";
    }
};
